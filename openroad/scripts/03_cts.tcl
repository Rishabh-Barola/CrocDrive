...
# Clock nets are no longer protected after placement.

# Important: EZ flip-flops use CK, not CLK.
...
clock_tree_synthesis -buf_list $ctsBuf -root_buf $ctsBufRoot -sink_clustering_enable -sink_clustering_max_diameter 50 -obstruction_aware -balance_levels
